...
const Header: React.FC<HeaderProps> = ({ searchTerm, setSearchTerm, onOpenFilters }) => {
    return (
        <header className="sticky top-0 z-10 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-sm border-b border-border-light dark:border-border-dark">
            <div className="px-4 py-3">
                <div className="flex items-center justify-between">
                    ...
                    <h1 className="text-lg font-bold text-foreground-light dark:text-foreground-dark">MotoMarket</h1>
